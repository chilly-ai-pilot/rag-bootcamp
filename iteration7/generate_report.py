...
<body>
    <div class="container">
        <header>
            ...
            <p>Continuous Evaluation Dashboard - Iteration 7</p>
            <p style="font-size: 0.95em; margin-top: 10px;">Latest: {metrics['dates'][-1]} | Total Runs: {len(results)}</p>
        </header>
"""
...
"""
    ...
    html_content += f"""
        <footer>
            <p>Generated by RAG Bootcamp Iteration 7 - Continuous Evaluation Pipeline</p>
...
def main():
    ...
    print(f"{'='*60}")
    print("RAG System Report Generator - Iteration 7")
    print(f"{'='*60}")
