...
try:
    ...
    hybrid_results = retrieve_hybrid(test_query, chunks, k=5, strategy="fixed_100_50")
    print(f"✅ Hybrid 检索返回 {len(hybrid_results)} 个结果")
    
    # 测试 rerank 检索
    rerank_results = retrieve_rerank(test_query, chunks, k=5, strategy="fixed_100_50", k_candidates=20)
...
print("=" * 60)
print("\n下一步:")
print("  运行完整评估: python3 run_eval.py --chunking-strategy fixed_100_50 --retrieval-mode rerank")
