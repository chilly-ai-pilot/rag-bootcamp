...
def run_single_strategy(args, chunking_strategy, retrieval_mode=None):
    ...
    return scores, mrr_scores, results, rerank_analysis, faithfulness_analysis, relevance_analysis, self_healing_stats
...
def main():
    ...
    # 运行单个策略和检索模式
    scores, mrr_scores, results, rerank_analysis, faithfulness_analysis, relevance_analysis, self_healing_stats = run_single_strategy(args, args.chunking_strategy, args.retrieval_mode)
